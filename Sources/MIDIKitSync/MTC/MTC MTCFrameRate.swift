...
extension MIDI.MTC {
    ...
    /*
     ...
     This means that actual frame rate cannot be reliably inferred from the MTC stream. See chart below for details.
     
     MTC can only describe four base frame rates. 24, 25, drop, and 30.
     All other actual rates in the DAW just become derived from one of those in order to transmit MTC. Backwards-compatibility basically.
