...
//        @MIDI.Atomic
        ...
        internal func generateFullFrameMIDIMessage() -> (
            ...
            let midiEvent = MIDI.Event.universalSysEx7(
        ...
        @inline(__always) internal func generateQuarterFrameMIDIMessage() -> MIDI.Event {
            ...
            case 0b000: // QF 0
                dataByte += (MIDI.Byte(mtcComponents.f) & 0b0000_1111)
            case 0b001: // QF 1
                dataByte += (MIDI.Byte(mtcComponents.f) & 0b0001_0000) >> 4
            case 0b010: // QF 2
                dataByte += (MIDI.Byte(mtcComponents.s) & 0b0000_1111)
            case 0b011: // QF 3
                dataByte += (MIDI.Byte(mtcComponents.s) & 0b0011_0000) >> 4
            case 0b100: // QF 4
                dataByte += (MIDI.Byte(mtcComponents.m) & 0b0000_1111)
            case 0b101: // QF 5
                dataByte += (MIDI.Byte(mtcComponents.m) & 0b0011_0000) >> 4
            case 0b110: // QF 6
                dataByte += (MIDI.Byte(mtcComponents.h) & 0b0000_1111)
            case 0b111: // QF 7
                dataByte += ((MIDI.Byte(mtcComponents.h) & 0b0001_0000) >> 4)
