...
final class MTC_Integration_Integration_Tests: XCTestCase {
    ...
    func testMTC_Integration_EncoderDecoder_29_97drop() {
        ...
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 00).toTimecode(rawValuesAt: ._29_97_drop))
        XCTAssertEqual(mtcEnc.mtcQuarterFrame, 0)
        mtcEnc.increment() // QF 0
        mtcEnc.increment() // QF 1
        mtcEnc.increment() // QF 2
        ...
        mtcEnc.increment() // QF 7
        mtcEnc.increment() // QF 0
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 02).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.increment() // QF 1
        mtcEnc.increment() // QF 2
        mtcEnc.increment() // QF 3
        mtcEnc.increment() // QF 4
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 03).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.increment() // QF 5
        mtcEnc.increment() // QF 6
        mtcEnc.increment() // QF 7
        mtcEnc.increment() // QF 0
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 04).toTimecode(rawValuesAt: ._29_97_drop))
        for _ in 1...(25 * 4) { mtcEnc.increment() } // advance 25 frames (4 QF per frame)
        XCTAssertEqual(mtcEnc.mtcQuarterFrame, 4)
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 29).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.increment() // QF 5
        mtcEnc.increment() // QF 6
        mtcEnc.increment() // QF 7
        mtcEnc.increment() // QF 0
        XCTAssertEqual(_timecode, TCC(h: 1, m: 01, s: 00, f: 02).toTimecode(rawValuesAt: ._29_97_drop))
        XCTAssertEqual(_direction, .forwards)
        mtcEnc.decrement() // QF 7
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 29).toTimecode(rawValuesAt: ._29_97_drop))
        XCTAssertEqual(_direction, .backwards)
        ...
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 29).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.decrement() // QF 3
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 28).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.decrement() // QF 2
        mtcEnc.decrement() // QF 1
        mtcEnc.decrement() // QF 0
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 28).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.decrement() // QF 7
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 27).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.decrement() // QF 6
        mtcEnc.decrement() // QF 5
        mtcEnc.decrement() // QF 4
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 27).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.decrement() // QF 3
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 26).toTimecode(rawValuesAt: ._29_97_drop))
        mtcEnc.decrement() // QF 2
        mtcEnc.decrement() // QF 1
        mtcEnc.decrement() // QF 0
        XCTAssertEqual(_timecode, TCC(h: 1, m: 00, s: 59, f: 26).toTimecode(rawValuesAt: ._29_97_drop))
    ...
    func testMTC_Integration_EncoderDecoder_fullFrameBehavior() {
        ...
        mtcEnc.locate(to: TCC(h: 1, m: 00, s: 00, f: 02).toTimecode(rawValuesAt: ._24),
                      transmitFullFrame: .always)
        ...
        mtcEnc.locate(to: TCC(h: 1, m: 00, s: 00, f: 02).toTimecode(rawValuesAt: ._25),
                      transmitFullFrame: .always)
        ...
        mtcEnc.locate(to: TCC(h: 1, m: 00, s: 00, f: 04).toTimecode(rawValuesAt: ._25),
